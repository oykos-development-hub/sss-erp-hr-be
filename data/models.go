...
type Models struct {
	...
	JobPositionsInOrganizationUnits       JobPositionsInOrganizationUnits
	Systematization                       Systematization
	UserProfile                           UserProfile
	EmployeeContract                      EmployeeContract
	EmployeesInOrganizationUnit           EmployeesInOrganizationUnit
	...
	Salary                                Salary
	UserNormFulfilment                    UserNormFulfilment
	EmployeeAbsent                        EmployeeAbsent
	RevisionsOfOrganizationUnit           RevisionsOfOrganizationUnit
	TendersInOrganizationUnit             TendersInOrganizationUnit
	TenderApplicationsInOrganizationUnit  TenderApplicationsInOrganizationUnit
	...
	Log                                   Log
	ErrorLog                              ErrorLog
	RevisionTipImplementation             RevisionTipImplementation
}
